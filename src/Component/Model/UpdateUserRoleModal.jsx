              ...
              <form>
                <div>
                  <select
                    ...
                    className='w-full my-3 border border-gray-200 dark:border-slate-800 select rounded-xl px-2 py-3'
                    name='role'
                    id=''
                  >
                    <option value='clinte'>Clinte</option>
                    <option value='staffe'>Staffe</option>
