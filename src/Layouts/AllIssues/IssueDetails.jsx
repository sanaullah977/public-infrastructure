          ...
          <div className=" flex flex-col">
            ...
            <div className="flex   flex-col">
              ...
              <div className="flex  m-10 mb-5 ">
                <div className="flex flex-col">
                  <span className="text-gray-400">
                    Provided By : {details?.reported_by}
                  </span>
                  <span className="text-gray-400">
                    Email:{details?.Email}
                  </span>
             ...
             <div>
               ...
               <button className="btn bg-green-400 ml-10 mx-auto text-white"> Update </button>
               {/* </Link> */}
                <button 
                onClick={handleDelete} 
                className="btn bg-green-400 ml-10 mx-auto text-white"> Resolve </button>
             </div>
            </div>
          </div>
        </div>
